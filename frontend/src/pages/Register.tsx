  ...
  return (
    <div className="min-h-[90vh] flex items-center justify-center bg-brand-base px-4 py-20 relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="w-full max-w-[500px] bg-white p-8 md:p-12 rounded-[32px] border border-brand-border shadow-2xl shadow-gray-200 relative z-10"
      >
        <div className="text-center space-y-4 mb-10">
          <h1 className="text-3xl font-normal text-brand-ink tracking-tight">Бүртгүүлэх</h1>
          <p className="text-brand-sub text-[14px] font-medium leading-relaxed">Enola Shop-ийн гишүүн болж хамгийн сүүлийн үеийн streetwear загваруудыг олж аваарай.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-2">
            <label className="text-[10px] font-black text-brand-hint uppercase tracking-[2px] ml-1">Бүтэн нэр</label>
            <div className="relative group">
              ...
              <input
                ...
                className="w-full h-12 pl-12 pr-4 bg-brand-surface border border-brand-border rounded-[14px] text-[14px] font-medium focus:border-brand-ink focus:bg-white outline-none transition-all placeholder:text-brand-hint/50"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-brand-hint uppercase tracking-[2px] ml-1">Нууц үг</label>
              <div className="relative group">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-brand-hint uppercase tracking-[2px] ml-1">Дахин нууц үг</label>
              <div className="relative group">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-brand-hint group-focus-within:text-brand-ink transition-colors" />
                <input
                  type="password"
          ...
          <Button
            type="submit"
            isLoading={isLoading}
            className="w-full h-14 bg-brand-ink text-brand-base rounded-[14px] font-black text-[13px] tracking-[3px] uppercase hover:bg-brand-ink2 transition-all transform hover:scale-[1.01] active:scale-[0.99] shadow-xl shadow-brand-ink/10 mt-6"
          >
            Бүртгүүлэх
          </Button>
        </form>
        ...
        <div className="mt-10 pt-8 border-t border-brand-border text-center">
          <p className="text-brand-sub text-[13px] font-medium mb-4">Бүртгэлтэй юу?</p>
          <Link 
            to="/login" 
