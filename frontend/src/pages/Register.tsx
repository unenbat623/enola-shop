      ...
      >
        ...
        <div className="space-y-4 mb-8">
          <Button
            ...
            className="w-full h-13 bg-white border-2 border-brand-border text-brand-ink rounded-[12px] font-bold text-[14px] hover:bg-brand-surface transition-all flex items-center justify-center gap-3 group"
          >
            <GoogleIcon />
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-[11px] uppercase tracking-[2px] font-black">
              <span className="bg-white px-4 text-brand-hint">Эсвэл и-мэйлээр</span>
            </div>
          </div>
        </div>
