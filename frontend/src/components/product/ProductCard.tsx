      ...
      <Link to={`/product/${product.slug}`} className="flex-1 flex flex-col">
        ...
        <div className="relative aspect-[3/4] bg-brand-surface overflow-hidden">
          ...
          <div className="absolute top-[10px] left-[10px] flex flex-col gap-2 z-10">
            {(product.badge === 'Шинэ' || product.badge === 'NEW') && (
            ...
            {(product.badge === 'Хямдрал' || product.badge === 'SALE') && (
            ...
            {(product.badge === 'HOT' || product.badge === 'Эрэлттэй') && (
              <span className="bg-brand-ink text-brand-base text-[9px] font-bold tracking-[1.5px] normal-case px-2 py-0.5 rounded-[3px]">Эрэлттэй</span>
            )}
          </div>
