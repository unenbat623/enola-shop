    ...
    <section className="py-24 bg-brand-surface relative overflow-hidden border-y border-brand-border">
      <div className="max-w-4xl mx-auto px-4 relative z-10 text-center space-y-10">
        <div className="space-y-4">
          <span className="text-brand-mint font-bold uppercase tracking-[2px] text-[11px]">STAY UPDATED</span>
          <h2 className="text-4xl md:text-5xl font-medium text-brand-white tracking-tight uppercase">JOIN THE COMMUNITY</h2>
        ...
        <form className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto" onSubmit={(e) => e.preventDefault()}>
          ...
          />
          <button className="h-12 px-10 bg-brand-mint rounded-[8px] font-bold text-sm uppercase tracking-wider hover:bg-brand-mint-dk transition-all flex items-center justify-center gap-3 cursor-pointer" style={{ color: 'var(--accent-dark)' }}>
             SUBSCRIBE
          </button>
        </form>
        
        <p className="text-brand-hint text-[10px] font-bold uppercase tracking-[2px]">
