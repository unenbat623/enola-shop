  ...
  return (
    <div className="bg-brand-base border border-brand-border rounded-[10px] p-9 w-full max-w-[400px] shadow-none mx-auto">
      <div className="space-y-2 mb-8 text-center">
        <h2 className="text-2xl font-normal text-brand-ink uppercase tracking-[2px]">Нэвтрэх</h2>
        <p className="text-brand-sub text-[13px]">Antigravity ертөнцөд тавтай морил.</p>
      </div>
